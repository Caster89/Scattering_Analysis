...
_AvlbSASFit = ['Sing_Gauss', 'Double_Gauss', 'Sing_Schultz', 'Double_Schultz',
                'Mono_Cube', 'Gauss_Cube','EM',\
                'Dist_from_EM',]
...
_AvlbWASFit = ['PVM']
_lmfitModels = ['Sing_Gauss', 'Double_Gauss', 'Sing_Schultz', 'Double_Schultz', 'Mono_Cube', 'Gauss_Cube']
