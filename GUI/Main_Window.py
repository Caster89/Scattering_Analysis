...
class Main_Window(QtWidgets.QMainWindow):
    '''Main window which contains all the widgets necessary to run the program
    '''
    ...
    def __init__(self, **kwargs):
        ...
        #The main widget is a splitter which allows to change the ratio between
        #the main plotting widget and the sidebars
        self.splitter = QtWidgets.QSplitter(self)
        #The left toolbar shows all the available datasets
        ...
        #Central widget is for plotting the data
        ...
        #Right widget is a toolbar to edit the plot and do fits
